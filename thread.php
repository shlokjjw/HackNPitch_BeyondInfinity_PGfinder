...
<body>
    ...
    echo '<div class="container">
        <h1 class="py-2">Post a Query</h1> 
        <form action= "'. $_SERVER['REQUEST_URI'] . '" method="POST"> 
            <div class="form-group">
                <label for="exampleFormControlTextarea1"><strong>Type your query</strong></label>
        ...
        <div class="container">
        <h1 class="py-2">Submit</h1> 
           <p class="lead">You are not logged in. Please login to be able to post query.</p>
        </div>
        ';
    }
    ...
    while($row = mysqli_fetch_assoc($result)){
        ...
        $sql2 = "SELECT user_email FROM `users` WHERE sno=$id";
        $result2 = mysqli_query($conn, $sql2);
        $row2 = mysqli_fetch_assoc($result2);
        ...
        echo '<div class="media my-3">
            ...
            <div class="media-body">
               <p class="font-weight-bold my-0">'. $user_email .'</p>'. $content.' 
            </div> 
        </div>';
    }
    if($noResult){
